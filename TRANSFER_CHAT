...
Текущая версия архива: v1.1.113
router-agent: 0.5.57
...
- UI v1.1.113 / agent 0.5.57: добавлен debug-блок сопоставления соединений для задачи «Сегодня» у провайдеров; также вынесена в Настройки отдельная регулировка непрозрачности карточек провайдеров.
