...
Текущая версия архива: v1.2.3
router-agent: 0.6.1

Последний фикс в этом релизе:
- на вкладке `Подписки` бейдж локального сценария переименован в более понятный `LAN-режим (локально)` и перестал выглядеть как ложная кнопка действия
- кнопка раскрытия внешнего HTTPS переименована в более прямую `Настроить внешний HTTPS`, чтобы было ясно, что это отдельный опциональный сценарий публикации
- статусный бейдж локального режима переведён в более нейтральный стиль, чтобы он воспринимался как индикатор, а не как действие
