...
- verify real-router behavior after `v1.2.164`:
  1. `Overview -> Router Health` no longer performs duplicate wake-up refreshes on viewport return
  ...
  5. if needed, continue safe upstream review for further low-risk load reductions only
