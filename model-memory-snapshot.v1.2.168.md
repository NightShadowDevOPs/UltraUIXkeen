...
- verify real-router behavior after `v1.2.168`:
  1. fast tab hide/show no longer causes duplicate `Router -> System` wake-up refreshes
  2. manual refresh and details loading still work correctly
