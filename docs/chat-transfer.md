...
Текущая версия архива: v1.1.108
router-agent: 0.5.53
...
- SSL-проверка больше не скрывает список провайдеров в Задачах; ошибки SSL показываются предупреждением поверх уже загруженного списка
