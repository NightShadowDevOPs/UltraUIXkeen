...
- добавлена дополнительная диаграмма трафика в стиле Netcraze на наших данных (включая трафик через XKeen)
- в блоке роутера есть проверка обновления прошивки по официальной странице Netcraze и уведомление о новой версии
- активный раздел в левом меню подсвечен заметнее
