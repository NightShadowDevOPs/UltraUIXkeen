...
## Release target
- UI package target for this release: **v1.2.144**
...
- This `v1.2.144` package focuses on actionable diagnostics cards for Host QoS and Traffic / Users, while keeping the Home Assistant bridge contract unchanged.
