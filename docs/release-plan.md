...
- **v1.2.149** — следующий функциональный шаг по traffic UX после стабилизации diagnostics-срезов.

## Package status
- Latest packaged release: **v1.2.146** (`UltraUIXkeen-v1.2.146.zip`)
- Latest chat-transfer pack: **v1.2.146** (`UltraUIXkeen-chat-transfer-v1.2.146.zip`)
- Latest HA handoff pack: **v1.2.146** (`UltraUIXkeen-ha-handoff-v1.2.146.zip`)

## Router-agent status
- Confirmed agent line: **0.6.31**

## What shipped in v1.2.146
- UI raised to **1.2.146**
- Router-agent remained **0.6.31**
- Host QoS diagnostic slices now sort rows by severity / relevance and show an inline reason badge for each row
- Traffic / Users diagnostic slices now sort rows by the active problem type and show an inline reason badge for each row
