...
- привести `Router → Трафик` к той же логике рабочих зон: короче верхний экран, понятнее акценты, меньше ощущения «ещё один длинный scroll»
- проверить, какие действия и статусы по QoS/устройствам стоит вынести на первый экран раздела
