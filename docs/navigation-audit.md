...
- заголовки рабочих зон перестали светить сырыми ключами вроде `routerTraffic`
- для Router-секций добавлены нормальные человекочитаемые названия
- для Traffic-режимов `Devices / Users` добавлены отдельные локализованные названия
